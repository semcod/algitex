# algitex Articles — WordPress-Ready Markdown
...
1. `algitex-ecosystem-overview.md` — context + architecture
...
9. `algitex-unified-toolchain.md` — the glue library (last, links to all)
