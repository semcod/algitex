...
class FeedbackController:
    ...
    ) -> Tuple[FailureStrategy, Dict[str, Any]]:
    ...
    def on_success(
        self, ticket: Dict[str, Any], result: Dict[str, Any]
    ) -> Dict[str, Any]:
...
class FeedbackLoop:
    ...
    def execute_with_feedback(
        self, ticket: Dict[str, Any], tool: str = "aider-mcp"
    ) -> Dict[str, Any]:
    ...
    def _mark_ticket_done(
        self, ticket: Dict[str, Any], tool: str, validation: Dict[str, Any]
    ):
        """Mark ticket as done."""
        self.docker_mgr.call_tool(
            ...
            "planfile_update_ticket",
            {
                ...
                "resolution": {
                    ...
                    "attempts": self.controller._ticket_attempts.get(
                        ticket.get("id"), 0
                    ),
                },
            },
