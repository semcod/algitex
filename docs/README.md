...
![version](https://img.shields.io/badge/version-0.1.0-blue) ![python](https://img.shields.io/badge/python-%3E%3D3.10-blue) ![coverage](https://img.shields.io/badge/coverage-unknown-lightgrey) ![functions](https://img.shields.io/badge/functions-890-green)
> **890** functions | **130** classes | **164** files | CC̄ = 3.5
...
```
algitex/
        ├── aider_mcp_server        ├── cli/        ├── project/    ├── algitex/            ├── loop        ├── planfile_mcp_server        ├── vallm_server            ├── config            ├── cicd        ├── config            ├── proxy            ├── autofix/            ├── docker_transport            ├── todo_parser        ├── algo/            ├── mcp            ├── docker            ├── parallel/            ├── ollama        ├── tools/            ├── telemetry            ├── workspace            ├── ide            ├── analysis            ├── context            ├── tickets            ├── todo_executor            ├── services            ├── logging            ├── todo_runner            ├── todo_actions            ├── todo_local            ├── docker            ├── parallel            ├── batch            ├── ticket            ├── feedback            ├── benchmark            ├── algo            ├── workflow            ├── workflow            ├── config            ├── mcp            ├── core            ├── autofix            ├── ollama            ├── ide            ├── services            ├── benchmark        ├── propact/            ├── batch            ├── pipeline            ├── todo        ├── todo/            ├── tiering            ├── micro            ├── benchmark            ├── fixer            ├── verifier                ├── base        ├── workflows/            ├── audit                ├── aider_backend            ├── hybrid                ├── fallback_backend                ├── proxy_backend                ├── ollama_backend                ├── batch_logger                ├── partitioner                ├── executor                ├── batch_backend        ├── buggy_code        ├── main        ├── buggy_code        ├── main        ├── main                ├── extractor        ├── main                ├── models        ├── workspace_parallel        ├── parallel_multi_tool        ├── main        ├── main        ├── parallel_refactoring        ├── parallel_real_world        ├── main        ├── main        ├── main        ├── main        ├── main        ├── main        ├── file3        ├── main        ├── main        ├── file2        ├── file1        ├── buggy_code        ├── main        ├── main        ├── main        ├── main        ├── main        ├── buggy_code        ├── main        ├── buggy_code        ├── main        ├── main        ├── main        ├── buggy_code        ├── main        ├── mcp_orchestrator        ├── main        ├── main        ├── main        ├── abpr_pipeline        ├── main        ├── main                ├── main            ├── main        ├── main            ├── complex_module            ├── calculator            ├── file3        ├── main        ├── main            ├── file2├── project        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run            ├── file1        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run        ├── run            ├── app```
...
📄 `src.algitex.cli.todo` (9 functions)
...
📄 `src.algitex.todo.fixer` (23 functions, 2 classes)
📄 `src.algitex.todo.hybrid` (10 functions, 4 classes)
📄 `src.algitex.todo.micro` (17 functions, 5 classes)
