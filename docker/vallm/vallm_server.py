...
class VallmServer:
    ...
    def create_fastapi_app(self) -> FastAPI:
        ...
        async def validate(request: Dict[str, Any]):
            ...
            return await self._run_validate(request.get("path", "/project"))
        ...
        async def batch_validate(request: Dict[str, Any]):
            ...
            result = await self._run_validate(path)
    ...
    async def _run_validate(self, path: str) -> Dict[str, Any]:
    ...
    def _analyze_complexity(self, path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return self._parse_radon_complexities(result.stdout)
        except Exception as e:
            logger.warning(f"Radon error: {e}")
            return {"average_cc": 3.0, "max_cc": 5.0, "files_analyzed": 0}

    def _parse_radon_complexities(self, stdout: str) -> Dict[str, Any]:
