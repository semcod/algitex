...
# code2llm | 311f 65722L | python:189,shell:27,yaml:20,yml:4,txt:2,toml:1 | 2026-04-25
# CC̄=2.6 | critical:10/1727 | dups:3 | cycles:0
...
LAYERS:
  ...
  │ Taskfile.yml               274L  0C    1m  CC=0.0    ←82
  ...
  │ !! calls.yaml                6564L  0C    0m  CC=0.0    ←0
  │ !! map.toon.yaml             1389L  0C  424m  CC=0.0    ←0
  │ !! calls.toon.yaml            653L  0C    0m  CC=0.0    ←0
...
COUPLING:
                                                                Taskfile                         src.algitex           examples.31-abpr-workflow               examples.09-workspace  examples.32-workspace-coordination                    examples.10-cicd            examples.18-ollama-local              examples.37-benchmarks      examples.40-three-tier-autofix      examples.30-parallel-execution                examples.08-feedback                 examples.07-context          examples.33-hybrid-autofix      examples.39-microtask-pipeline    examples.20-self-hosted-pipeline
                            Taskfile                                  ──                                ←516                                 ←81                                 ←71                                 ←68                                 ←65                                 ←61                                 ←60                                 ←60                                 ←56                                 ←57                                 ←53                                 ←45                                 ←46                                 ←45  hub
                         src.algitex                                 516                                  ──                                                                      ←2                                                                      ←1                                                                                                                                              ←3                                                                                                          ←3                                                                          hub
  ...
  examples.32-workspace-coordination                                  68                                                                                                                                              ──                                                                                                                                                                                                                                                                                                                                                                          !! fan-out
      ...
      examples.30-parallel-execution                                  56                                   3                                                                                                                                                                                                                                                                                              ──                                                                                                                                                                                      !! fan-out
          ...
          examples.33-hybrid-autofix                                  45                                   3                                                                                                                                                                                                                                                                                                                                                                                                          ──                                                                          !! fan-out
      examples.39-microtask-pipeline                                  46                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ──                                      !! fan-out
    examples.20-self-hosted-pipeline                                  45                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ──  !! fan-out
  CYCLES: none
  HUB: Taskfile/ (fan-in=1870)
...
# redup/duplication | 50 groups | 193f 32646L | 2026-04-25
...
HOTSPOTS[7] (files with most duplication):
  ...
  examples/36-dashboard/main.py  dup=69L  groups=4  frags=4  (0.2%)
  examples/39-microtask-pipeline/main.py  dup=61L  groups=4  frags=4  (0.2%)

DUPLICATES[50] (ranked by impact):
...
REFACTOR[50] (ranked by priority):
  [1] ○ extract_function   → examples/34-batch-fix/utils/demo_batch_dry_run.py
      WHY: 3 occurrences of 44-line block across 1 files — saves 88 lines
      FILES: examples/34-batch-fix/main.py
  [2] ○ extract_function   → examples/utils/demo_orchestrator_pattern.py
  ...
  [3] ○ extract_function   → examples/utils/demo_dashboard_monitor.py
  ...
  [4] ◐ extract_function   → src/algitex/tools/utils/stop_service.py
  ...
  [5] ◐ extract_class      → src/algitex/tools/utils/_register_default_tools.py
  ...
  [6] ○ extract_function   → examples/utils/main.py
  ...
  [7] ○ extract_function   → docker/utils/run_rest_server.py
  ...
  [8] ◐ extract_function   → examples/utils/create_sample_project.py
  ...
  [13] ○ extract_function   → src/algitex/tools/autofix/utils/_error_result.py
      WHY: 3 occurrences of 11-line block across 3 files — saves 22 lines
      FILES: src/algitex/tools/autofix/aider_backend.py, src/algitex/tools/autofix/openrouter_backend.py, src/algitex/tools/autofix/proxy_backend.py
  [14] ○ extract_function   → examples/40-three-tier-autofix/utils/demo_tier_micro.py
      WHY: 2 occurrences of 20-line block across 1 files — saves 20 lines
      FILES: examples/40-three-tier-autofix/main.py
  [15] ○ extract_function   → src/algitex/todo/utils/_first_int.py
  ...
  [16] ○ extract_function   → src/algitex/tools/autofix/utils/_execute_fix.py
  ...
  [17] ○ extract_function   → examples/utils/demo_microtask_plan.py
  ...
  [18] ○ extract_function   → src/algitex/tools/autofix/utils/_build_prompt.py
      WHY: 2 occurrences of 14-line block across 2 files — saves 14 lines
      FILES: src/algitex/tools/autofix/openrouter_backend.py, src/algitex/tools/autofix/proxy_backend.py
  [19] ○ extract_function   → docker/utils/run.py
  ...
  [20] ○ extract_function   → examples/utils/calculate.py
  ...
  [21] ○ extract_function   → src/algitex/tools/autofix/utils/fix.py
      WHY: 2 occurrences of 12-line block across 2 files — saves 12 lines
      FILES: src/algitex/tools/autofix/openrouter_backend.py, src/algitex/tools/autofix/proxy_backend.py
  [22] ○ extract_function   → src/algitex/tools/utils/__init__.py
  ...
  [25] ○ extract_function   → src/algitex/tools/autofix/utils/_success_result.py
      WHY: 2 occurrences of 10-line block across 2 files — saves 10 lines
      FILES: src/algitex/tools/autofix/openrouter_backend.py, src/algitex/tools/autofix/proxy_backend.py
  [26] ○ extract_function   → examples/utils/process_items.py
      WHY: 2 occurrences of 8-line block across 2 files — saves 8 lines
      FILES: examples/23-continue-dev-ollama/buggy_code.py, examples/26-litellm-proxy-ollama/buggy_code.py
  [27] ○ extract_function   → src/algitex/microtask/utils/_resolve_path.py
      WHY: 2 occurrences of 8-line block across 2 files — saves 8 lines
      FILES: src/algitex/microtask/executor.py, src/algitex/microtask/slicer.py
  [28] ○ extract_class      → src/algitex/tools/utils/_setup_signal_handlers.py
      WHY: 2 occurrences of 8-line block across 2 files — saves 8 lines
  ...
  [43] ○ extract_function   → src/algitex/tools/autofix/utils/_write_file.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/autofix/openrouter_backend.py, src/algitex/tools/autofix/proxy_backend.py
  [44] ○ extract_class      → src/algitex/tools/utils/__post_init__.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/ide.py, src/algitex/tools/ide_models.py
  [45] ○ extract_class      → src/algitex/tools/utils/__init__.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/ide.py, src/algitex/tools/ide_base.py
  [46] ○ extract_class      → src/algitex/tools/utils/list_tools.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/ide.py, src/algitex/tools/ide_base.py
  [47] ○ extract_class      → src/algitex/tools/utils/setup_environment.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/ide.py, src/algitex/tools/ide_claude.py
  [48] ○ extract_function   → src/algitex/tools/utils/handler.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/mcp.py, src/algitex/tools/mcp_orchestrator.py
  [49] ○ extract_function   → src/algitex/tools/utils/close.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/ollama.py, src/algitex/tools/services.py
  [50] ○ extract_class      → src/algitex/tools/utils/status_icon.py
      WHY: 2 occurrences of 3-line block across 2 files — saves 3 lines
      FILES: src/algitex/tools/services.py, src/algitex/tools/services/models.py

QUICK_WINS[31] (low risk, high savings — do first):
  [1] extract_function   saved=88L  → examples/34-batch-fix/utils/demo_batch_dry_run.py
      FILES: main.py
  [2] extract_function   saved=84L  → examples/utils/demo_orchestrator_pattern.py
      FILES: main.py, main.py, main.py +1
  [3] extract_function   saved=52L  → examples/utils/demo_dashboard_monitor.py
      FILES: main.py, main.py, main.py +1
  [6] extract_function   saved=34L  → examples/utils/main.py
      FILES: main.py, main.py, main.py
  [7] extract_function   saved=32L  → docker/utils/run_rest_server.py
      FILES: aider_mcp_server.py, code2llm_mcp_server.py, planfile_mcp_server.py +2
  [9] extract_function   saved=27L  → src/algitex/cli/utils/ticket.py
      FILES: __init__.py
  [10] extract_function   saved=26L  → src/algitex/todo/utils/_process_fstring_batch.py
      FILES: fixer.py
  [11] extract_class      saved=22L  → src/algitex/tools/utils/setup_tool.py
      FILES: ide.py, ide_base.py
  [12] extract_function   saved=22L  → src/algitex/tools/autofix/utils/_dry_run_result.py
      FILES: aider_backend.py, openrouter_backend.py, proxy_backend.py
  [13] extract_function   saved=22L  → src/algitex/tools/autofix/utils/_error_result.py
      FILES: aider_backend.py, openrouter_backend.py, proxy_backend.py

EFFORT_ESTIMATE (total ≈ 29.7h):
  ...
  medium _process_fstring_batch              saved=26L  ~52min
  ... +40 more (~700min)

METRICS-TARGET:
  dup_groups:  50 → 0
  saved_lines: 795 lines recoverable
```
