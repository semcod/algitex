...
def main():
    ...
    print("Commands:")
    print("  python mcp_orchestrator.py start     # Start all services")
    print("  python mcp_orchestrator.py stop      # Stop all services")
    print("  python mcp_orchestrator.py status    # Check status")
    print("  python mcp_orchestrator.py restart   # Restart service")
    print()
    print("Features:")
